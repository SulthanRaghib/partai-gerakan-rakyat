              ...
              <details className="group bg-background rounded-2xl border border-foreground/10 overflow-hidden shadow-sm" open>
                ...
                <div className="p-5 border-t border-foreground/10 bg-foreground/5 text-sm md:text-base">
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-2 mb-1"><Phone className="w-4 h-4 text-muted-foreground" /> H. Husaini (817778121)</div>
                  </div>
                  <div>
                    <h5 className="font-bold text-red-600 dark:text-red-400 mb-2">Dewan Pakar:</h5>
                    <div className="flex items-center gap-2 mb-1"><Phone className="w-4 h-4 text-muted-foreground" /> H. Jamal (81911270288)</div>
                    <div className="flex items-center gap-2 mb-1"><Phone className="w-4 h-4 text-muted-foreground" /> M. Jamil (81310243965)</div>
                  </div>
                </div>
              </details>
              ...
              <details className="group bg-background rounded-2xl border border-foreground/10 overflow-hidden shadow-sm">
                ...
                <div className="p-5 border-t border-foreground/10 bg-foreground/5 grid md:grid-cols-2 gap-4 text-sm">
                  <div className="flex flex-col bg-background p-3 rounded-lg border border-foreground/5">
                    ...
                    <span className="text-red-600 flex items-center gap-1 mt-1"><Phone className="w-3 h-3" /> 85697136634</span>
                  </div>
                  <div className="flex flex-col bg-background p-3 rounded-lg border border-foreground/5">
                    ...
                    <span className="text-red-600 flex items-center gap-1 mt-1"><Phone className="w-3 h-3" /> 82117436708</span>
                  </div>
                  <div className="flex flex-col bg-background p-3 rounded-lg border border-foreground/5">
                    <span className="text-xs text-muted-foreground font-semibold">Sekretaris</span>
                    <span className="font-bold">Drs. Suwito</span>
                    <span className="text-red-600 flex items-center gap-1 mt-1"><Phone className="w-3 h-3" /> 89510379131</span>
                  </div>
                  <div className="flex flex-col bg-background p-3 rounded-lg border border-foreground/5">
                    ...
                    <span className="text-red-600 flex items-center gap-1 mt-1"><Phone className="w-3 h-3" /> 82299931551</span>
                  </div>
                  <div className="flex flex-col bg-background p-3 rounded-lg border border-foreground/5">
                    <span className="text-xs text-muted-foreground font-semibold">Bendahara</span>
                    <span className="font-bold">Hj. Andi Yuliyanah</span>
                    <span className="text-red-600 flex items-center gap-1 mt-1"><Phone className="w-3 h-3" /> 81295070462</span>
                  </div>
                  <div className="flex flex-col bg-background p-3 rounded-lg border border-foreground/5">
                    <span className="text-xs text-muted-foreground font-semibold">Wakil Bendahara</span>
                    <span className="font-bold">Wildayani</span>
                    <span className="text-red-600 flex items-center gap-1 mt-1"><Phone className="w-3 h-3" /> 85215084363</span>
                  </div>
                </div>
              </details>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>Tujiman (87821203343)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Romzi Zaini (81293317123)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Yanti Nuryanti (81913545039)</li>
                      </ul>
                    </div>
                    {/* Cilegon */}
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>Yusepksayid (0895635092866)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Zulkarnain (085781413765)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Elistamegawati (081398492128)</li>
                      </ul>
                    </div>
                    {/* Jombang */}
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>Masfar Munaf (81363210578)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Muhammad Danus (82258473280)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Meliawati (87776772272)</li>
                      </ul>
                    </div>
                    {/* Citangkil */}
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>Amsa Rizal (85314501991)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Abdullah (87774118234)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Sri Purnamayanti (87871477430)</li>
                      </ul>
                    </div>
                    {/* Pulomerak */}
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>Hikmatullah (87877926088)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Jayanto (82114040836)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Melisa (895365198042)</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-5 border-t border-foreground/10 bg-foreground/5">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>H. Sanwani (87773845688)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Nurlelah (81805874663)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Astuni (87774082963)</li>
                      </ul>
                    </div>
                    {/* Purwakarta */}
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>Ma'ruf (895341408627)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>-</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Sindi Allan AB (81400358183)</li>
                      </ul>
                    </div>
                    {/* Gerogol */}
                    <div>
                      ...
                      <ul className="grid sm:grid-cols-3 gap-2 text-sm">
                        <li><span className="text-muted-foreground">Ketua:</span><br/>M. Yunus, SH. (81389093553)</li>
                        <li><span className="text-muted-foreground">Wakil Ketua:</span><br/>Rahmatullah (81398153729)</li>
                        <li><span className="text-muted-foreground">Sekretaris:</span><br/>Widi Wigiyahwati (85357621127)</li>
                        <li><span className="text-muted-foreground">Bendahara:</span><br/>Marthino SB (81387526745)</li>
                      </ul>
                    </div>
                  </div>
                </div>
